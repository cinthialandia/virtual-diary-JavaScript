...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findQuestionByDate", function() { return findQuestionByDate; });
...
function findQuestionByDate(date) {
...
function saveAnswer(answer, date) {
  ...
  const questionToAnswer = findQuestionByDate(date); //guardamos arriba en una variable la pregunta encontrada para poder saber la ruta donde vamos a guardar la respuesta en el objeto
...
/* harmony import */ var _welcome_section__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./welcome-section */ "./src/welcome-section.js");
/* harmony import */ var _question_section__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./question-section */ "./src/question-section.js");
...
_router__WEBPACK_IMPORTED_MODULE_0__["default"].on('welcome', function () {
  ...
  before: function (done) {
    const owner = Object(_db__WEBPACK_IMPORTED_MODULE_1__["findOwnersName"])();

    if (owner) {
      _router__WEBPACK_IMPORTED_MODULE_0__["default"].navigate('');
    } else {
      done();
    }
  }
  ...
  before: function (done) {
    ...
    if (!owner) {
      _router__WEBPACK_IMPORTED_MODULE_0__["default"].navigate('welcome');
    } else {
      done();
    }
  }
...
/***/ "./src/question-section.js":
/*!*********************************!*\
  !*** ./src/question-section.js ***!
  \*********************************/
/*! exports provided: initQuestionForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initQuestionForm", function() { return initQuestionForm; });
...
function initQuestionForm() {
  ...
  const questionObjToday = Object(_db__WEBPACK_IMPORTED_MODULE_0__["findQuestionByDate"])(todayDate); //1. QUERY SELECTORS
  //1.5 seleccionamos el form donde se encuentra el input y el boton

  const questionFormElm = container.querySelector('.question-form'); //1.2 Estamos seleccionando el input del calendario.
  ...
  renderQuestionObj(questionObjToday); //INITI EVENT LISTENERS
...
function renderQuestionObj(questionObj) {
  ...
  const questionElm = document.querySelector('.question'); //1.3 seleccionar div vacio donde voy a meter las respuestas anteriores

  const answerContainerElm = document.querySelector('.answers-container'); //2.1 Inyecta la pregunta como título en el HTML

  questionElm.innerHTML = questionObj.title; // Si la pregunta no tiene respuesta, return nada. y asi no va a tratar renderizar algo que no existe.
  ...
  const answersEntries = Object.entries(questionObj.answers).reverse(); //2.2 variable done guardare el string del template resultado del for

  let answersHTML = ''; //2.3 Realizamos el for para escoger mostrar el key y value, se hace un loop sobre un objeto y extraer los valores.
...
function handleDatepickerInput(e) {
  ...
  let newDate = e.target.valueAsDate; //3.3 llamamos la funcion aqui, para tener acceso a la variable newdate
...
function handleQuestionFormSubmit(event) {
  ...
  const answer = event.target.answer.value; //traer la fecha cuando se dio submit la respuesta

  const selectedDate = getDatePickerElm().valueAsDate; //se llama la function,con los parametros necesario
  ...
  const questionObjectUpdated = Object(_db__WEBPACK_IMPORTED_MODULE_0__["saveAnswer"])(answer, selectedDate); // le pasamos a la funcion que esta encargada de renderizar las respuestas en el html
...
/* harmony default export */ __webpack_exports__["default"] = ([{
  ...
  title: 'iOS, Windows or Linux',
  day: 15,
  month: 3
}, {
  title: 'Do you believe in anything superior?',
  day: 16,
  month: 3
}, {
  title: 'Cat or dog?',
  ...
  title: 'How Long Would You Last In A Zombie Apocalypse?',
  day: 18,
  month: 3
}, {
  title: 'What “Old Person” Things Do You Do?',
  day: 19,
  month: 3
}, {
  title: 'If Mars Was Livable, Would You Accept A One-Way Ticket There?',
  day: 20,
  month: 3
}, {
  ...
  title: 'If You Could Write One New Law That Everyone Had To Obey, What Law Would You Create?',
  day: 22,
  month: 3
}, {
  ...
  title: 'What guilty pleasure do you have?',
  day: 25,
  month: 3
}, {
  title: 'What Cartoon Do You Still Like To Watch?',
  day: 26,
  month: 3
}, {
  title: 'Book or movie?',
  ...
  title: 'If You Could Shop For Free At One Store, Which One Would You Choose?',
  day: 29,
  month: 3
}, {
  ...
  title: 'A chore you ignored today',
  day: 2,
  month: 4
}, {
  title: 'What sound effect are you most like today?',
  day: 2,
  month: 4
}, {
  title: 'Write down a new fact you recently learned',
  day: 4,
  month: 4
}, {
  title: 'What is your favorite thing to do on a Sunday morning?',
  day: 5,
  month: 4
}, {
  ...
  title: 'Sandals or sneakers?',
  day: 7,
  month: 4
}, {
  title: 'What Is The Most Important Object You Own?',
  day: 8,
  month: 4
}, {
  title: 'Which celebrity would you want to interview?',
  day: 9,
  month: 4
}, {
  title: "What's a political issue that interests you?",
  day: 10,
  month: 4
}, {
  title: 'What do you think is your biggest shortcoming?',
  day: 11,
  month: 4
}, {
  title: 'What famous person would you bring back from the dead to have dinner with?',
  day: 12,
  month: 4
}, {
  ...
  title: 'What Makes You Feel Young?',
  day: 14,
  month: 4
}, {
  ...
  title: 'Pasta or pizza?',
  day: 16,
  month: 4
}, {
  title: 'If You Could Ask Your Pet 3 Questions, What Would They Be?',
  day: 17,
  month: 4
}, {
  title: 'What Simpsons Character Are You?',
  day: 18,
  month: 4
}, {
  title: 'What Separates True Friends From Acquaintances?',
  day: 19,
  month: 4
}, {
  title: 'Online shopping or in-person shopping?',
  day: 20,
  month: 4
}, {
  ...
  title: 'Do You Believe Things Happen For A Reason?',
  day: 22,
  month: 4
}, {
  title: 'Which artist is overrated?',
  day: 23,
  month: 4
}, {
  title: 'Do You Think Our Justice System Is Fair?',
  day: 24,
  month: 4
}, {
  title: 'Do You Believe In Sorcery?',
  day: 25,
  month: 4
}, {
  title: 'Do You Believe That We All Have Souls?',
  day: 26,
  month: 4
}, {
  title: 'What Is A Superstition You Used To Believe In?',
  day: 27,
  month: 4
}, {
  title: 'How much spare change do you have?',
  day: 28,
  month: 4
}, {
  ...
  title: 'Who would you trade places with for just one day?',
  day: 30,
  month: 4
}, {
  title: 'What are three words to describe your social life?',
  day: 1,
  month: 5
}, {
  title: 'Messy or neat?',
  ...
  title: 'When was the last time you went swimming?',
  day: 4,
  month: 5
}, {
  title: 'What was the last party you went to?',
  day: 5,
  month: 5
}, {
  title: 'Who would play you in a movie about your life? Is it a good movie?',
  day: 6,
  month: 5
}, {
  title: 'Who is your famous crush?',
  day: 7,
  month: 5
}, {
  title: 'What makes a good enemy?',
  day: 8,
  month: 5
}, {
  title: 'What do you consider to be your biggest achievement?',
  day: 9,
  month: 5
}, {
  ...
  title: 'Have you done anything illegal on purpose?',
  day: 13,
  month: 5
}, {
  title: 'Have you doubted your sexual orientation?',
  day: 14,
  month: 5
}, {
  ...
  title: 'If you could know the absolute and total truth to one question, what question would you ask?',
  day: 18,
  month: 5
}, {
  title: 'What ridiculous thing has someone tricked you into doing or believing?',
  day: 19,
  month: 5
}, {
  ...
  title: 'What is your idea of a perfect vacation?',
  day: 31,
  month: 5
}, {
  ...
  title: 'What is your favorite thing to do on a Friday night?',
  day: 5,
  month: 6
}, {
  ...
  title: 'Pizza with pineapple or without pineapple?',
  day: 8,
  month: 6
}, {
  title: 'What are your thoughts on online dating or tinder?',
  day: 9,
  month: 6
}, {
  ...
  title: 'What are your top five favorite movies?',
  day: 15,
  month: 6
}, {
  ...
  title: 'If you could live anywhere in the world where would it be?',
  day: 19,
  month: 6
}, {
  ...
  title: 'What is your favorite alcoholic beverage? Some special brand?',
  day: 21,
  month: 6
}, {
  ...
  title: 'What are some of your own personal goals in the next 5 years?',
  day: 26,
  month: 6
}, {
  title: 'If heaven is real and you died tomorrow, would you get in?',
  day: 27,
  month: 6
}, {
  ...
  title: 'What was the last road trip you took?',
  day: 12,
  month: 7
}, {
  title: 'Are you more productive at night or in the morning? Do you think it’s possible to change and get used to another schedule?',
  day: 13,
  month: 7
}, {
  title: 'What food do you love that a lot of people might find a little odd?',
  day: 14,
  month: 7
}, {
  title: 'If you could start a charity, what would it be for?',
  day: 15,
  month: 7
}, {
  title: 'What is your favorite meme?',
  day: 16,
  month: 7
}, {
  ...
  title: 'Do you think you have a pretty good work-life balance? Why or why not?',
  day: 18,
  month: 7
}, {
  ...
  title: 'What do you rebel against?',
  day: 21,
  month: 7
}, {
  ...
  title: 'What do you resent paying for most?',
  day: 23,
  month: 7
}, {
  ...
  title: 'How handy are you when it comes to fixing things?',
  day: 25,
  month: 7
}, {
  ...
  title: 'What were your favorite television shows when you were growing up?',
  day: 27,
  month: 7
}, {
  title: 'What do you want to do when you retire?',
  day: 28,
  month: 7
}, {
  title: 'Who is the most competitive person you know?',
  day: 29,
  month: 7
}, {
  ...
  title: 'What is the worst compliment you have received?',
  day: 31,
  month: 7
}, {
  title: 'Do you make enough money?',
  day: 1,
  month: 8
}, {
  title: 'Write down your last sent text message',
  day: 2,
  month: 8
}, {
  title: "What's your favorite piece of clothing?",
  day: 3,
  month: 8
}, {
  title: 'Yes or no: Everyone should have a backup plan.',
  day: 4,
  month: 8
}, {
  ...
  title: 'How would you describe your victory dance?',
  day: 6,
  month: 8
}, {
  title: 'What was the last wedding you attended?',
  day: 7,
  month: 8
}, {
  title: 'What household chore do you actually enjoy?',
  day: 8,
  month: 8
}, {
  title: 'If you had to lose one of your senses, which would you choose to lose?',
  day: 9,
  month: 8
}, {
  title: 'What was your worst haircut experience?',
  day: 10,
  month: 8
}, {
  title: 'What is the most stressful TV show or movie you watched?',
  day: 11,
  month: 8
}, {
  title: 'How often do you dance?',
  day: 12,
  month: 8
}, {
  title: 'What’s your favorite thing about the area/city/state you live in?',
  day: 13,
  month: 8
}, {
  title: 'What card or board games do you like to play?',
  day: 14,
  month: 8
}, {
  title: 'Who is the most gifted person you know?',
  day: 15,
  month: 8
}, {
  title: 'What are you kind of snobby about?',
  day: 16,
  month: 8
}, {
  title: 'What is the best thing you have ever bought?',
  day: 17,
  month: 8
}, {
  ...
  title: 'Netflix or YouTube?',
  day: 20,
  month: 8
}, {
  title: 'How would you rank the following in importance: Family, career, love life?',
  day: 21,
  month: 8
}, {
  ...
  title: 'What life-changing event have you experienced?',
  day: 23,
  month: 8
}, {
  title: 'At what age do you think people should think of settling down?',
  day: 24,
  month: 8
}, {
  title: 'Are you afraid of becoming your parents?',
  day: 25,
  month: 8
}, {
  title: 'What is your view about monogamy?',
  day: 26,
  month: 8
}, {
  title: 'What qualities are you looking for in a partner?',
  day: 27,
  month: 8
}, {
  title: 'Is the human good or bad by nature?',
  day: 28,
  month: 8
}, {
  ...
  title: 'Do you believe we make our own happy endings, or is fate responsible for them?',
  day: 30,
  month: 8
}, {
  ...
  title: 'Is happiness a state of mind or we need to act in order to achieve it?',
  day: 1,
  month: 9
}, {
  title: 'Would you rather be teacher or student?',
  day: 2,
  month: 9
}, {
  title: 'Is your home clean?',
  day: 3,
  month: 9
}, {
  title: 'Write down a minor, but chronic, problem',
  day: 4,
  month: 9
}, {
  ...
  title: 'What is your favorite snack food?',
  day: 6,
  month: 9
}, {
  title: 'Do you handle rejection well?',
  day: 7,
  month: 9
}, {
  ...
  title: 'Bad news: Sugarcoated or straight-up?',
  day: 9,
  month: 9
}, {
  title: 'How do you get out of a rut?',
  day: 10,
  month: 9
}, {
  title: 'If you died tonight, what would you regret not doing?',
  day: 11,
  month: 9
}, {
  title: 'Do you like who you are now?',
  day: 12,
  month: 9
}, {
  ...
  title: 'Is your job now a reflection of what you said you wanted to be when you were a kid?',
  day: 14,
  month: 9
}, {
  title: 'Do you believe that the present is really better than the past?',
  day: 15,
  month: 9
}, {
  title: 'At what age do you think people should get married?',
  day: 16,
  month: 9
}, {
  title: 'Do you think you will be a great parent, and why?',
  day: 17,
  month: 9
}, {
  ...
  title: 'Do you believe in burning bridges when it comes to exes?',
  day: 19,
  month: 9
}, {
  ...
  title: 'What is the greatest invention of this age?',
  day: 21,
  month: 9
}, {
  title: 'Which one wins: reality or imagination?',
  day: 22,
  month: 9
}, {
  title: 'When was the last time you said “I love you” to your parents?',
  day: 23,
  month: 9
}, {
  title: 'What do you think will bring about humanity’s extinction?',
  day: 24,
  month: 9
}, {
  ...
  title: 'What aspect of my personality still needs improvement?',
  day: 26,
  month: 9
}, {
  title: 'Mobile Games or Console Games?',
  day: 27,
  month: 9
}, {
  title: 'Have I done something recently that I could be proud of?',
  day: 28,
  month: 9
}, {
  title: 'Which one is a better situation: broke or lonely?',
  day: 29,
  month: 9
}, {
  title: 'What are three things that are on your bucket list?',
  day: 30,
  month: 9
}, {
  title: 'Who is the person with whom you can talk about anything?',
  day: 1,
  month: 10
}, {
  title: 'Is it okay to sacrifice one life to save ten?',
  day: 2,
  month: 10
}, {
  title: 'What annoys me the most?',
  day: 3,
  month: 10
}, {
  title: 'Horror Movie or Comedy Movie?',
  day: 4,
  month: 10
}, {
  title: 'How often have I said yes when I wanted to say no?',
  day: 5,
  month: 10
}, {
  title: 'Beer or Wine?',
  ...
  title: 'What important lesson have I learned this week?',
  day: 7,
  month: 10
}, {
  title: 'Dine In or Delivery?',
  day: 8,
  month: 10
}, {
  title: 'My perception of fame is?',
  day: 9,
  month: 10
}, {
  title: 'What is your favorite letter of the alphabet?',
  day: 10,
  month: 10
}, {
  title: 'Who is your favorite actor / actress?',
  day: 11,
  month: 10
}, {
  title: 'What was the last bad movie you watched?',
  day: 12,
  month: 10
}, {
  ...
  title: 'What question makes you anxious?',
  day: 14,
  month: 10
}, {
  title: 'Yo want a new?',
  ...
  title: "What's the most valuable thing you own?",
  day: 16,
  month: 10
}, {
  title: 'What famous living person would you want to meet for drinks?',
  day: 17,
  month: 10
}, {
  title: 'What was your last credit card purchase?',
  day: 18,
  month: 10
}, {
  title: 'What new word have you learned?',
  day: 19,
  month: 10
}, {
  title: 'Who is the last person in your missed calls?',
  day: 20,
  month: 10
}, {
  ...
  title: 'Camping or hotel?',
  day: 22,
  month: 10
}, {
  title: 'If you could change careers tomorrow, what would you do?',
  day: 23,
  month: 10
}, {
  title: 'What is a controversial opinion you have?',
  day: 24,
  month: 10
}, {
  title: 'Where is the most beautiful place you have been?',
  day: 25,
  month: 10
}, {
  title: 'What is the most childish thing you still do?',
  day: 26,
  month: 10
}, {
  title: 'What smell brings back great memories?',
  day: 27,
  month: 10
}, {
  title: 'How often do you help others? Who do you help? How do you help?',
  day: 28,
  month: 10
}, {
  ...
  title: 'What is the most useful app on your phone?',
  day: 30,
  month: 10
}, {
  title: "Halloween plans? What's your costume?",
  day: 31,
  month: 10
}, {
  title: "What was something you couldn't do today?",
  day: 1,
  month: 11
}, {
  title: 'What topic are you bored talking about?',
  day: 2,
  month: 11
}, {
  ...
  title: 'Where do you find pleasure?',
  day: 4,
  month: 11
}, {
  title: 'What was the last risk you took?',
  day: 5,
  month: 11
}, {
  title: 'Have you traveled to any different countries? Which ones?',
  day: 6,
  month: 11
}, {
  title: 'Do you care about fashion? What style of clothes do you usually wear?',
  day: 7,
  month: 11
}, {
  ...
  title: 'If you were a king/queen, what would your throne look like?',
  day: 9,
  month: 11
}, {
  title: 'What is the worst hotel you have stayed at? How about the best hotel?',
  day: 10,
  month: 11
}, {
  title: 'Time freezes for everyone but you for one day. What do you do?',
  day: 11,
  month: 11
}, {
  title: 'Do you think that aliens exist?',
  day: 12,
  month: 11
}, {
  ...
  title: 'What was the last photo you took?',
  day: 14,
  month: 11
}, {
  title: 'What makes you roll your eyes every time you hear it?',
  day: 15,
  month: 11
}, {
  ...
  title: 'If magic was real, what spell would you try to learn first?',
  day: 17,
  month: 11
}, {
  ...
  title: 'What songs hit you with a wave of nostalgia every time you hear them?',
  day: 19,
  month: 11
}, {
  title: 'Rock or Pop music?',
  day: 20,
  month: 11
}, {
  ...
  title: 'What was your most recent lie?',
  day: 22,
  month: 11
}, {
  ...
  title: 'What about the opposite sex confuses you the most?',
  day: 25,
  month: 11
}, {
  title: "Who's your least favorite celebrity?",
  day: 26,
  month: 11
}, {
  title: 'Do you think that humans will ever be able to live together in harmony?',
  day: 27,
  month: 11
}, {
  ...
  title: 'What brand are you most loyal to?',
  day: 30,
  month: 11
}, {
  title: 'How many goals did you accomplish this year?',
  day: 1,
  month: 12
}, {
  title: 'Where do you see yourself next year?',
  day: 2,
  month: 12
}, {
  ...
  title: 'Write down a recent transition',
  day: 4,
  month: 12
}, {
  title: 'What book has influenced you the most?',
  day: 5,
  month: 12
}, {
  title: 'Warm Lighting Or Bright White Lighting?',
  day: 6,
  month: 12
}, {
  title: 'What’s The Toughest Decision You Ever Made?',
  day: 7,
  month: 12
}, {
  title: 'How Many Times A Day Do You Look In The Mirror?',
  day: 8,
  month: 12
}, {
  ...
  title: 'Would you rather live without music or without television?',
  day: 10,
  month: 12
}, {
  title: 'What did you Google last?',
  day: 11,
  month: 12
}, {
  title: 'Would you rather be able to breathe underwater or fly?',
  day: 12,
  month: 12
}, {
  title: 'What trend are you tired of?',
  day: 13,
  month: 12
}, {
  ...
  title: 'Would you rather be the strongest person in the world or the fastest person in the world?',
  day: 15,
  month: 12
}, {
  title: 'What was the biggest realization you had about yourself?',
  day: 16,
  month: 12
}, {
  title: 'What are the unwritten rules of where you work?',
  day: 17,
  month: 12
}, {
  ...
  title: 'What’s the best type of cheese?',
  day: 19,
  month: 12
}, {
  ...
  title: 'What near future predictions do you have?',
  day: 21,
  month: 12
}, {
  ...
  title: 'Who is the most creative person you know?',
  day: 23,
  month: 12
}, {
  title: 'How was your last Christmas?',
  day: 24,
  month: 12
}, {
  title: 'Did you get any christmas presents?',
  day: 25,
  month: 12
}, {
  ...
  title: 'Do you need vacations?',
  day: 27,
  month: 12
}, {
  title: 'Would you rather the world be taken over by robots or by aliens?',
  day: 28,
  month: 12
}, {
  ...
  title: 'What are your plans for the new year?',
  day: 30,
  month: 12
}, {
...
const router = new navigo__WEBPACK_IMPORTED_MODULE_0___default.a(null, true);
/* harmony default export */ __webpack_exports__["default"] = (router);

/***/ }),

/***/ "./src/welcome-section.js":
/*!********************************!*\
  !*** ./src/welcome-section.js ***!
  \********************************/
/*! exports provided: initWelcomeForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initWelcomeForm", function() { return initWelcomeForm; });
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./db */ "./src/db.js");
...
function handleWelcomeFormSubmit(event) {
  ...
  event.preventDefault(); //guardamos en una variable el nombre que se introduce en el input
  ...
  Object(_db__WEBPACK_IMPORTED_MODULE_0__["saveOwnersName"])(ownersName); //navegar a la pagina de question

  _router__WEBPACK_IMPORTED_MODULE_1__["default"].navigate('');
}
